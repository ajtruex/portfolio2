<template>
  <div>
    <section class="hero is-medium is-primary is-bold">
      <div class="hero-body">
        <div class="container">
          <h1 class="title is-2">Meet Mark</h1>
        </div>
      </div>
    </section>
        ...
        <div class="columns">
          <div class="column">
            <div class="box">
              ...
              <p>
                Focused on building user interfaces with JS (Vue, Angular, ES6),
                HTML, and CSS (Sass) that are well designed and functional.
              </p>
            </div>
          </div>
          <div class="column">
            <div class="box">
              ...
              <p>
                ...
                Node, Mongo, and Firebase and Heroku to deliver production
          ...
          <div class="column">
            <div class="box">
              ...
              <p>
                6 years of startup experience as a co-founder of Knotty Tie Co.
                Managed and contributed to development, UX, marketing, service,
                and operations.
              </p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="columns is-centered">
          <div class="column is-four-fifths">
            <p>
              In 2013, I co-founded Knotty Tie Co, a custom tie manufacturer
              built from the ground up to employ resettling refugees. I built
              technology and processes for design, sales, service, marketing,
              and manufacturing that helped us put nearly 100,000 products in
              our customers' hands and spurred growth to 23 employees and $1.6
        ...
        <div class="columns is-centered">
          ...
          <div class="column is-one-fifth">
            <div class="box">
              ...
              <p>Proficient in ES6 and ES5 JS</p>
            </div>
          </div>
          <div class="column is-one-fifth">
            <div class="box">
          ...
          <div class="column is-one-fifth">
            <div class="box">
              ...
              <p>Apps using Cloud Firestore and Cloud Storage</p>
            </div>
          </div>
        </div>
        <p
